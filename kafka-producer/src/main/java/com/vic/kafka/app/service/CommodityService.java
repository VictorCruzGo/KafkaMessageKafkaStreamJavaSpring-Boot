package com.vic.kafka.app.service;
...
public class CommodityService {
	...
	static {
		...
		COMMODITY_BASE.put(COPPER, new Commodity(COPPER, 5_407.25, "tonne", timestamp));
	}
	...
	public List<Commodity> createDummyCommodities() {
		...
		COMMODITY_BASE.keySet().forEach(c->{
				result.add(createDummyCommodity(c));
		});
